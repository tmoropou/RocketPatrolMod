class Menu extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('sfx_explosion1', './assets/explosion5.wav');
        this.load.audio('sfx_explosion2', './assets/explosion12.wav');
        this.load.audio('sfx_explosion3', './assets/explosion13.wav');
        this.load.audio('sfx_explosion4', './assets/explosion15.wav');
